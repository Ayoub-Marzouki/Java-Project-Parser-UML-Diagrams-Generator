...
public class Realization {
	...
	public static void drawAdjacent(Graphics g, int[] sourcePosition, int[] targetPosition, int direction) {
	    ...
	    if (direction == 0) {
		    Utilities.drawArrow(g2d, childX, childY, childX, childY, 4);
	    } else {
		    Utilities.drawArrow(g2d, parentX, parentY, parentX, parentY, 2);
	    }
	}
	...
	public static void draw(Graphics g, int[] sourcePosition, int[] targetPosition, int direction, int verticalLineLength) {
	    ...
	    if (direction == 0) {
		    Utilities.drawArrow(g2d, childX, childY, childX, childY, 3);
		    
	    } else {
		    Utilities.drawArrow(g2d, childX, childY, childX, childY, 1);
	    }
	}
