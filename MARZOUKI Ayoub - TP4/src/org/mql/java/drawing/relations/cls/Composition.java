...
public class Composition {
	...
	public static void drawAdjacent(Graphics g, int[] sourcePosition, int[] targetPosition, int direction) {
	    ...
	    if (direction == 0) {
		    Utilities.drawCompositionSign(g2d, childX, childY, 4);
	    } else {
		    Utilities.drawCompositionSign(g2d, parentX, parentY, 2);
	    }
	}
	...
	public static void draw(Graphics g, int[] sourcePosition, int[] targetPosition, int direction, int verticalLineLength) {
	    ...
	    if (direction == 0) {
		    Utilities.drawCompositionSign(g2d, childX, childY, 3);
		    
	    } else {
		    Utilities.drawCompositionSign(g2d, childX, childY, 1);
	    }
	}
