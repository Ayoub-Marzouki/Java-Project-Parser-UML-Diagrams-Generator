...
//	classContentRectangle's y = classNameRectangle's height, same goes for classMethodsRectangle, also class rect means fields rectangle
	...
	public void paintComponent(Graphics g) {
		...
		Utilities.drawCenteredText(g2d, className, nameRectCoordinates[0], nameRectCoordinates[1], nameRectCoordinates[2], nameRectCoordinates[3]);
		Utilities.drawCenteredText(g2d, fieldsUML, classRectCoordinates[0], classRectCoordinates[1], classRectCoordinates[2], classRectCoordinates[3]);
		Utilities.drawCenteredText(g2d, methodsUML, methodsRectCoordinates[0], methodsRectCoordinates[1], methodsRectCoordinates[2], methodsRectCoordinates[3]);
	}
